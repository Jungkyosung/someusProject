...
const TodoList = (props) => {
    ...
    const handlerInputFocusOut = (id, e) => {
        ...
        props.setTodos(prevState => {
            ...
            //서버에 put으로 수정 요청
            axios.put(`http://localhost:8080/api/someus/private/goal/${id}`, data,
                {
                    headers: header
                }).then(response => {
                    if (response.data === 1) {
    ...
    const handlerClickEraser = (id) => {
        ...
        axios.delete(`http://localhost:8080/api/someus/private/goal/${id}`,
            {
    ...
    const handelrAddTodo = () => {
        ...
        //서버에 post로 입력 요청
        axios.post(`http://localhost:8080/api/someus/private/goal`, data,
            {
                headers: header
            }).then(response => {
                if (response.data === 1) {
